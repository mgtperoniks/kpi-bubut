...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('tracking.operator.index', ['date' => $summary->kpi_date]) }}" class="flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
    <div class="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
        ...
        <div class="flex items-center gap-3 w-full md:w-auto">
            <div class="bg-blue-100 text-blue-600 rounded-full h-10 w-10 flex items-center justify-center font-bold text-base shrink-0">
                {{ substr($summary->operator->name ?? $summary->operator_code, 0, 2) }}
            </div>
            <div class="leading-tight">
                <div class="font-bold text-gray-800 text-lg">{{ $summary->operator->name ?? $summary->operator_code }}</div>
